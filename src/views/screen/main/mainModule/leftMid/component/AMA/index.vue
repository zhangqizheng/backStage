 ...
 * @LastEditTime: 2020-11-03 13:43:24
...
export default {
  ...
  data() {
    return {
      ...
      playerOptions: {
        ...
        hls: true, // 直播数据流时候更改为true
        poster: require('@/assets/image/monitoringloading1.png'), // 你的封面地址
  ...
  computed: {
    player() {
      return this.$refs.videoPlayerHls.player// 自定义播放
    }
  },
  watch: {
    videourl: {
